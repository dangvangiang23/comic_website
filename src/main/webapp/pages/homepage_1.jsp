...
<html>
    ...
    <body>
        <div class="wrapper">
            <jsp:include page="../pages/separate/header.jsp" />
            <br/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-left" height: auto !important >
                                    ...
                                    <c:if test="${requestScope.newlist != null}">
                                        <div class="pda manga-list clearfix">
                                            <c:forEach items="${requestScope.newlist}" var="c">
                                                <div class="m-item">
                                                    <div class="m-img">
                                                        <a href="/${pageContext.request.contextPath}/displaycomic?cid=${c.cid}" title="${c.cname}">
            ...
            <jsp:include page="../pages/separate/footer.jsp" />
        </div>
