...
<%--        <link rel="stylesheet" href="../pages/homepage.css"/>--%>
        <link href="<c:url value='../pages/homepage.css' />" rel="stylesheet">
        <style>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-left" height: auto !important >
                                    ...
                                    <div class="pda manga-list clearfix">
                                        <c:forEach items="${requestScope.afterList}" var="c">
                                            <div class="m-item">
                                                <div class="m-img">
